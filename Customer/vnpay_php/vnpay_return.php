        ...
        <div class="container">
            ...
            <div class="table-responsive">
                ...
                <div class="form-group">
                        ...
                        if ($secureHash == $vnp_SecureHash) {
                            if ($_GET['vnp_ResponseCode'] == '00') {
                                ...
                                if (count($row) > 0) {
                                    ...
                                    $sql = "INSERT INTO payments(order_id, user, money, note, vnp_response_code, code_vnpay, code_bank, time) VALUES ('$order_id', '$taikhoan', '$money', '$note', '$vnp_response_code', '$code_vnpay', '$code_bank','$date_time')";
                                    $row = execute($sql);
                                }
                    ...
                    <br>
                    <a href="http://localhost:88/DoAn_MaNguonMo/Customer/Giaodien/trangchu.php">
